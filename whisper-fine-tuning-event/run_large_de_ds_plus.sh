...
deepspeed run_speech_recognition_seq2seq_streaming_de.py \
	...
	--language="german" \
	--task="transcribe" \
    --model_name_or_path="./outputs/hf_event/whisper-large-v2-ft-lr4e6-bs256-steps3k-dropout005-casepunc-ds" \
	--output_dir="./outputs/hf_event/whisper-large-v2-ft-lr4e6-bs256-steps3k-dropout005-casepunc-ds-plus-2k-3e7-wo-dropout" \
